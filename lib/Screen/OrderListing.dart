...
class _OrderListingState extends State<OrderListing> {
                                                  ...
                                                  children: [
                                                    Text("Vendor Name : ",
                                                        style: TextStyle(
                                                            ...
                                                            fontSize: 16)),
                                                    Text(
                                                        "${orderList[i].vendorName.toString()}",
                                                        style: TextStyle(
                                                            fontWeight:
                                                                FontWeight.w600,
                                                            fontSize: 16)),
                                                  ...
                                                  children: [
                                                    Text("Total Item : ",
                                                        style: TextStyle(
                                                            ...
                                                            fontSize: 16)),
                                                    Text(
                                                        "${orderList[i].orderItems?.length.toString()}",
                                                        style: TextStyle(
                                                            fontWeight:
                                                                FontWeight.w600,
                                                            fontSize: 16)),
  ...
  Future<void> ordercancledOrder(String orderId) async {
    ...
    var request =
        http.MultipartRequest('POST', Uri.parse('${ApiServicves.cancleOrder}'));
    request.fields.addAll({'id': orderId.toString(), 'status': '4'});
  ...
  void deletePopop(String OrderId) {
    showDialog(
        context: context,
