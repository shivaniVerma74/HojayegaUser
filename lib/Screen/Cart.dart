                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        if(getCatList.isEmpty){
                          ...
                          Fluttertoast.showToast(msg: "Product Not Available In Cart Please Add Product In Cart");
                        }
                       else if(addressids==null){


                          Fluttertoast.showToast(msg: "Plaese Select Address");
                        }else if(timefrom==null){
                          Fluttertoast.showToast(msg: "Plaese Select Time Slot");


                        }else if(selectwhehicle==null){
                          Fluttertoast.showToast(msg: "Plaese Select Vehicle Type");


                        }else if(selectOrders==null){
                          Fluttertoast.showToast(msg: "Plaese Select Order Type");
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: const [
                          ...
                          Text("",  style: TextStyle(fontSize: 1, fontWeight: FontWeight.w400))
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Column(
                        children: [
                          getAddressList.isNotEmpty?Column(
                            children: [
                              Row(children: [
                                ...
                                InkWell(
                                    ...
                                    child: Text("Manage Address",style: TextStyle(color: colors.secondary,fontSize: 16,fontWeight: FontWeight.bold),)),
                              ...
                              DropdownButtonFormField<dynamic>(
                                ...
                                onChanged: ( newValue) {
                                  setState(() {
                                    ...
                                    print("===my technic=======${selectaddress.id}===============");
                                  });
                                },
                                items: getAddressList.map((dynamic orderitem) {
                                  return DropdownMenuItem(
                                    value: orderitem,
                                    child: SizedBox(

                                        width: MediaQuery.of(context).size.width/1.5,
                                        child: Text(orderitem.address.toString(), style: TextStyle(color: colors.secondary),overflow: TextOverflow.ellipsis,maxLines: 1,)),
                                  );
                                }).toList(),
                            ...
                            child: Container(
                              ...
                              child: Card(
                                ...
                                child:
                                  ...
                                  Row(children: [
                                    SizedBox(width: 10,),
                                    Text("Tab To Add Address",style: TextStyle(color: colors.whiteTemp,fontSize: 16,fontWeight: FontWeight.w500,),),
                                    Spacer(),
                                    Icon(Icons.location_searching_sharp,color: colors.whiteTemp,),
                                    SizedBox(width: 5,),
                    ...
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: const [
                          Text("Cart Products", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
                          Text("",  style: TextStyle(fontSize: 1, fontWeight: FontWeight.w400))
                        ],
                      ),
                    ),
                                ...
                                child: Row(
                                  children: [
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(image: NetworkImage('${getCatList[index].productImage}'),fit: BoxFit.fill)),
                                      ),
                                    ),
                                    ...
                                    Column(
                                      ...
                                      children:  [
                                        Text("${getCatList[index].productName}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15),),
                                        SizedBox(height: 10),
                                        Container(
  ...
  color: colors.primary,
                                          ...
                                          child: Center(
                                            child: Text(
                                              ...
                                              style:
                                              TextStyle(fontSize: 16, fontWeight: FontWeight.w400,color: colors.whiteTemp),
                                            ),
                                          ),
                                        ),
                                  ...
                                  children:  [
                                    InkWell(
                                      onTap: () {
                                        ...
                                        _descrementerCounter(getCatList[index].quantity??"",getCatList[index].vendorId??"",getCatList[index].productId??"");

                                      },
                                        child: const Icon(Icons.remove, color: Colors.black, size: 30,)),
                                    Text("${getCatList[index].quantity}", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800),),
                                    InkWell(
                                      onTap: () {

                                        _incrementCounter(getCatList[index].quantity??"",getCatList[index].vendorId??"",getCatList[index].productId??"");
                                      },
                                        child: const Icon(Icons.add, color: Colors.black, size: 30)),
                                    InkWell(
                                      onTap: () {
                                        deletePopop(getCatList[index].cartId??"");
                        ...
                        Container(
                            ...
                            child: Center(child: Text('Product Not Found Please Add Product In Cart'),)),
                    SizedBox(height: 10,),
                    ...
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: const [
                          Text("Time Slot", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
                          Text("",  style: TextStyle(fontSize: 1, fontWeight: FontWeight.w400))
                        ],
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: const [
                          Text("Order Type", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
                          Text("",  style: TextStyle(fontSize: 1, fontWeight: FontWeight.w400))
                        ],
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: const [
                          Text("Vehicle Type", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
                          Text("",  style: TextStyle(fontSize: 1, fontWeight: FontWeight.w400))
                        ],
                      ),
                    ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                Icon(Icons.check,color: colors.primary,size: 15,):SizedBox.shrink()),
                              ),
                              SizedBox(width: 10,),
                              Container(height: 30,width: 30,
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(3),
                                    ...
                                    image: DecorationImage(image: AssetImage("assets/images/cycling.png"),fit: BoxFit.fill)),
                              )
                            ...
                            children: [
                              ...
                              Container(height: 30,width: 30,
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(3),
                                    ...
                                    image: DecorationImage(image: AssetImage("assets/images/bike.png"),fit: BoxFit.fill)),
                              )
                            ...
                            children: [
                              ...
                              Container(height: 30,width: 30,
                                ...
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(3),
                                    ...
                                    image: DecorationImage(image: AssetImage("assets/images/AUTO - Copy.png"),fit: BoxFit.fill)),
                              )
                            ...
                            children: [
                              ...
                              Container(height: 30,width: 30,
                                ...
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(3),
                                    ...
                                    image: DecorationImage(image: AssetImage("assets/images/TRUCK - Copy.png"),fit: BoxFit.fill)),
                              )
...
print("===my technic=======${selectBikeType}===============");                          });
                              },
...
bool isLoading=false;
  ...
  Future<void> getCrt() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${ApiServicves.baseUrl}get_cart_items'));
...
for(int i=0;i<getCatList.length;i++){
  ...
  Future<void> removeCrt(String cartIDD) async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${ApiServicves.baseUrl}remove_cart_items'));
    request.fields.addAll({
  ...
  getAddress() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${ApiServicves.getAddress}'));
    request.fields.addAll({
      'user_id': user_id.toString(),
    });
...
print("===my technic=======${request.fields}===============");
 ...
 await response.stream.bytesToString();
  ...
  placeproduct() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${ApiServicves.placeOrder}'));
    request.fields.addAll({
    ...
    if (response.statusCode == 200) {
      ...
      if(finalresult['status']==true){
        ...
        Fluttertoast.showToast(msg: "${finalresult['message']}");
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const OrderListing()));
