          ...
          Row(
            children: [
              SizedBox(
                      ...
                      width: MediaQuery.of(context).size.width/1.7,                child: Text("${getAddressList[index].address}",style: TextStyle(fontWeight:FontWeight.w400,color: colors.primary ),maxLines: 4,overflow: TextOverflow.ellipsis,)),
            ],
          ),
          Row(
            children: [
              ...
              Text("#Flat No :",style: TextStyle(fontWeight:FontWeight.w400,color: colors.primary ),),
              Text("${getAddressList[index].building??"0"}",style: TextStyle(fontWeight:FontWeight.w400,color: colors.primary ),),
            ],
          ),
        ],
                             ...
                             children: [
                               ...
                               InkWell(
                                   onTap: () {
                                     ...
                                     Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Addaddress(isEdit: true,addressList:getAddressList[index] ),));
                               ...
                               InkWell(
                                   onTap: () {
                                     ...
                                     deletePopop(getAddressList[index].id.toString());
           ...
           Container(height: MediaQuery.of(context).size.height,
             ...
             width: MediaQuery.of(context).size.width,
             child: Center(child: Text('Address Not Found Please Add Address'),),
           )
         ) :
...
bool isLoading=false;
  ...
  Future<void> removeAddress(String addressId) async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${ApiServicves.deleteAddress}'));
    request.fields.addAll({
