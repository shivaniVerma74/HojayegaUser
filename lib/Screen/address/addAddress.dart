  ...
  if(countryId==null){
    ...
    AddAddress();
             ...
             width: MediaQuery.of(context).size.width,
               decoration: BoxDecoration(borderRadius: BorderRadius.circular(6),color: colors.primary ),
               child: Center(child:

               widget.isEdit==true?
               Text('Update Address',style: TextStyle(color: colors.whiteTemp,fontWeight: FontWeight.bold),):
               Text('Add Address',style: TextStyle(color: colors.whiteTemp,fontWeight: FontWeight.bold),),
...
readOnly: true,
                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                        borderSide:
                        const BorderSide(color: colors.primary, width: 2)),
...
lang=widget.addressList?.lng??"";
  ...
  AddAddress() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${ApiServicves.addAddress}'));
...
Navigator.pop(context);
  ...
  updateAddress() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${ApiServicves.updateAddress}'));
    request.fields.addAll({
      'address': addresscontroller.text.toString(),
      'building': houseNumbercontroller.text.toString(),
      'city':  cityId.toString(),
