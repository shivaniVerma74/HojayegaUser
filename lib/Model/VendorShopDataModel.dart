...
VendorShopDataModel vendorShopDataModelFromJson(String str) =>
    VendorShopDataModel.fromJson(json.decode(str));

String vendorShopDataModelToJson(VendorShopDataModel data) =>
...
class VendorShopDataModel {
  ...
  factory VendorShopDataModel.fromJson(Map<String, dynamic> json) =>
      VendorShopDataModel(
        error: json["error"],
        message: json["message"],
        status: json["status"],
        user:
            List<UserData>.from(json["user"].map((x) => UserData.fromJson(x))),
      );
