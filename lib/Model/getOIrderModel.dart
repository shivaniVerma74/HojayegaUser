class GetOrderModel {
  ...
  factory GetOrderModel.fromJson(Map<String, dynamic> json) => GetOrderModel(
        ...
        orders: List<GetOrderModelList>.from(
            json["orders"].map((x) => GetOrderModelList.fromJson(x))),
        status: json["status"],
      );
...
class GetOrderModelList {
  ...
  factory GetOrderModelList.fromJson(Map<String, dynamic> json) =>
      GetOrderModelList(
        ...
        driverData: json["driver_data"] == null
            ? []
            : List<DriverDatum>.from(
                json["driver_data"].map((x) => DriverDatum.fromJson(x))),
        ...
        count: json["count"],
        isAccepted: json['accept_reject_vendor'],
      );
