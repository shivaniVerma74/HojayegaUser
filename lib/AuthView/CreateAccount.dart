...
class _CreatAState extends State<CreateAccount> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //           top: 30,
      //           left: 20,
      //           child: Text('Create Account', style: TextStyle(fontSize: 35,
      //               fontWeight: FontWeight.bold,
      //               color: Colors.white),)),
      //       const Positioned(
      //           top: 80,
      ...
      //           left: 50,
      //           right: 50,
      //           child: Image.asset("assets/images/create account.png", scale: 1.4,)),
      //       Positioned(
      //         top: 20,
      //         bottom: 30,
      //         left: 20,
      ...
      //                           height: 45,
      //                           color: Colors.grey.shade200,
      //                           child: const Icon(Icons.email, size: 25,
      //                             color: Colors.green,),
      //                         ),
      //                       ),
      //                       Expanded(
      ...
      //                           height: 45,
      //                           color: Colors.grey.shade200,
      //                           child: const Icon(Icons.lock, size: 25,
      //                             color: Colors.green,),
      //                         ),
      //                       ),
      //                       Expanded(
      ...
      //                           height: 45,
      //                           color: Colors.grey.shade200,
      //                           child: const Icon(Icons.location_on_sharp, size: 25,
      //                             color: Colors.green,),
      //                         ),
      //                       ),
      //                       Expanded(
      ...
      //                 Row(
      //                   children: [
      //                     Checkbox(value: isChecked,activeColor: Colors.green,
      //                         shape: RoundedRectangleBorder(
      //                             borderRadius: BorderRadius.circular(4)
      //                         ),
      //                         onChanged: (val){
      ...
      //                     const Text('and', style: TextStyle(fontSize: 12)),
      //                     TextButton(onPressed: () {},
      //                         child: const Text('privacy policy', style: TextStyle( fontSize: 12,fontWeight: FontWeight.w500,),))
      //                   ],
      //                 ),
      //                 const SizedBox(
      //                   height: 15,
