...
if(widget.forget==true){
   request =
  http.MultipartRequest('POST', Uri.parse(ApiServicves.sendOtpforgetpassword));
    ...
    if (response.statusCode == 200) {
      ...
      if (finaResult['status']==1) {
        ...
        Navigator.pushReplacement(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    VerifyOtp(OTP: otp.toString(), forget: widget.forget,userid: userId.toString(),)));
      }
      else {
        Fluttertoast.showToast(msg: "${finaResult['msg']}");
      }
        ...
        if (finaResult['error'] == false) {
          ...
          Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      VerifyOtp(OTP: otp.toString(), forget: widget.forget,)));
        }
        else {
          Fluttertoast.showToast(msg: "${finaResult['message']}");
        }
      ...
      child: Scaffold(
        ...
        child: Stack(
          children: [
            ...
            widget.forget == true?SizedBox.shrink():
             Positioned(
                top: 120,
                left: 20,
