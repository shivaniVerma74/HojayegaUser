...
class _ForgetPasswordState extends State<ForgetPassword> {
  ...
  sendOtp() async {
    ...
    request.fields.addAll({'user_id': widget.userId.toString(),
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration:  InputDecoration(
                                          ...
                                          suffixIcon: IconButton(
                                            ...
                                            icon: Icon(
                                              isVisible1 ? Icons.remove_red_eye : Icons.visibility_off,
                                              color: Colors.green,
                                            ),
                                          ),
                                          // suffixIcon: suffixIcons,
                                      ...
                                      validator: (value) {
                                       ...
                                       else if (conpasswordcontroller.text.toString()!=passwordcontroller.text.toString()) {
