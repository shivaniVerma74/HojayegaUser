          ...
          child: Stack(
            children: [
              ...
              Container(
                ...
                child: IconButton(
                  icon: const Center(child: Icon(Icons.arrow_back, color: Colors.green,)),
                  onPressed: (){
              ...
              const Positioned(
                  top: 60,
                  left: 20,
                  child: Text('Forget Password', style: TextStyle(fontSize: 35,
              ...
              Positioned(
                  ...
                  left: 50,
                  right: 50,
                  child: Image.asset("assets/images/FORGOT PASSWORD.png", scale: 1.4,)),
